...
!Flowchart showing HTTP request retry logic with exponential backoff for retryable status codes and error type mapping
...
!Class diagram showing BaseHTTPClient with retry logic inherited by RaindropClient with typed API methods
